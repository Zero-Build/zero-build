  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log("cookies response:", cookiesRes);
        // Handle if cookiesRes is an array
        const policy = Array.isArray(cookiesRes) ? cookiesRes[0] : cookiesRes;
        setCookies(policy || null);
      } catch (err) {
          ...
          {cookies ? (
            <div>
              ...
              <div className="text-gray-600 prose prose-sm max-w-none">
                {Array.isArray(cookies.description) && cookies.description.length > 0 ? (
                  <PortableText value={cookies.description} />
                ) : (
